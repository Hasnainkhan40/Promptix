...
const navItems = [
  ...
  { to: "/ai/remove-background", label: "RemoveBackground", Icon: Eraser },
  ...
  return (
    ...
    >
      <div className="my-7 w-full">
        ...
        items-center gap-3 rounded ${isActive ? "bg-linear-to-r from-[#3C81F6] to-[#9234EA] text-white" : ""}`}
            >
              {({ isActive }) => (
                <>
      ...
      <div
        className="w-full border-t border-gray-200 p-4 px-7 flex items-center
        justify-between "
      >
        <div

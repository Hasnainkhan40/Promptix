...
const onSubmitHandler = async (e) => {
  ...
  try {
    ...
    else toast.error(data.message || "Failed to remove background");
  } catch (error) {
...
rounded-md border border-gray-300 text-gray-600"
          placeholder="The future of artificial
intelligence is..."
          required
        />
...
bg-linear-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
        >
...
text-gray-400"
          >
            ...
            <p>Enter an image and click "Remove background" to get started</p>
          </div>
        </div>) : (

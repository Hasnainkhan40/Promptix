...
const GenerateImages = () => {
   ...
   const ImageStyle = [
    "Realistic", "Cartoon", "3D Render", "Digital Art", "Photography", "Pixel Art", "Line Art", "Watercolor", "Oil Painting", "Surreal"
      ];
...
bg-linear-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
        >
          <Image className="w-5" />
          Generate Image
        </button>
